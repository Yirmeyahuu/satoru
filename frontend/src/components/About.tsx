        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start max-w-6xl mx-auto">
          ...
          <div className="about-content">
            ...
            <div className="about-stats grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="about-stat px-6 py-4 rounded-lg border border-cyan-500/30 bg-cyan-500/5 backdrop-blur-sm">
                <div className="text-cyan-400 text-sm font-semibold mb-1">Founded</div>
                <div className="text-gray-100 text-xl font-bold">2025</div>
              </div>
              <div className="about-stat px-6 py-4 rounded-lg border border-purple-500/30 bg-purple-500/5 backdrop-blur-sm">
                <div className="text-purple-400 text-sm font-semibold mb-1">Team Size</div>
                <div className="text-gray-100 text-xl font-bold">10+</div>
              </div>
              <div className="about-stat px-6 py-4 rounded-lg border border-pink-500/30 bg-pink-500/5 backdrop-blur-sm">
                <div className="text-pink-400 text-sm font-semibold mb-1">Global Reach</div>
                <div className="text-gray-100 text-xl font-bold">40+</div>
              </div>
            </div>
          </div>
